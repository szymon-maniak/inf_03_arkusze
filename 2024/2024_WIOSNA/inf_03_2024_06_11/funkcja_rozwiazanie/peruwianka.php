...
<body>
    ...
    <section id="glowny">
        ...
        <?php
            polaczenie(
                "SELECT DISTINCT(data_ur), miot, rasy.rasa FROM `swinki` JOIN rasy ON swinki.rasy_id = rasy.id WHERE rasy.id LIKE 1;",
                function($tab) {
        ...
        <?php
            polaczenie(
                "SELECT imie, cena, opis FROM `swinki` WHERE rasy_id LIKE 1;",
                function($tab) {

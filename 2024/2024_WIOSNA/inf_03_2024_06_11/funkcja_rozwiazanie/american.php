...
<body>
    ...
    <img src="american.jpg" alt="Świnka morska rasy american">
        ...
        <?php
            polaczenie(
                "SELECT DISTINCT(data_ur), miot, rasy.rasa FROM `swinki` JOIN rasy ON swinki.rasy_id = rasy.id WHERE rasy.id LIKE 6;",
                function($tab) {
        ...
        <?php
            polaczenie(
                "SELECT imie, cena, opis FROM `swinki` WHERE rasy_id LIKE 6;",
                function($tab) {

function aktywacja(blok){
    ...
    if(blok == 1) document.getElementById('blok1').style.display = "block";
    else if(blok == 2) document.getElementById('blok2').style.display = "block";
    else if(blok == 3) document.getElementById('blok3').style.display = "block";
}
